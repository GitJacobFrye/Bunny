...
class BunnyPhi3OnellmConfig(Phi3Config):
    model_type = "bunny-phi3-onellm"
...
#     config_class = BunnyPhi3OnellmConfig
...
#         # 自适应层
#         self.dim_projector = nn.AdaptiveAvgPool1d(3072)

#         # Initialize weights and apply final processing
#         self.post_init()
#         # print(f"是否有projector:{self.mm_projector}")

class BunnyPhi3ForCausalLM_onellm(Phi3ForCausalLM, BunnyMetaForCausalLM):
    config_class = BunnyPhi3OnellmConfig
...
AutoConfig.register("bunny-phi3-onellm", BunnyPhi3OnellmConfig)
AutoModelForCausalLM.register(BunnyPhi3OnellmConfig, BunnyPhi3ForCausalLM_onellm)
